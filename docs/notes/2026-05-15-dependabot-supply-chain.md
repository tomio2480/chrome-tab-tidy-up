...
公式 postmortem で `@tanstack/virtual` ファミリーは **confirmed-clean** と明記されており，
...
マージ可能な PR が複数ある場合，1 件ずつ順番にマージするより
全件にリベースを依頼してから CI 通過を待ち，CLEAN になった順にマージする方が効率的．
